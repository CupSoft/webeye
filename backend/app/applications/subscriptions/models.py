...
class Subscription(BaseDBModel, BaseCreatedUpdatedAtModelMixin, UUIDDBModelMixin):
    ...
    resource: fields.ForeignKeyRelation['Resource'] = fields.ForeignKeyField(
        'models.Resource', related_name='subscriptions', to_field='hashed_id', on_delete=fields.CASCADE
    )
    user: fields.ForeignKeyRelation['User'] = fields.ForeignKeyField(
        'models.User', related_name='subscriptions', to_field='hashed_id', on_delete=fields.CASCADE
    )
